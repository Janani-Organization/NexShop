...
import com.example.order_service.service.PdfInvoiceService;
import com.example.order_service.models.Order;
import com.example.order_service.CustomExceptions.OrderNotFoundException;
...
public class OrderController {
    ...
    public ResponseEntity<byte[]> downloadInvoice(@PathVariable Long orderId) {
        try {
            Order order = service.getOrderEntity(orderId);
